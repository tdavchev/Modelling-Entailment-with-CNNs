...
#def build_me(data, f_p_y_given_xs1,f_p_y_given_xs2):  
def build_me(f_p_y_given_xs1,f_weights11,f_weights21,f_weights31,f_weights41,f_bias11,f_p_y_given_xs2,f_weights12,f_weights22,f_weights32,f_weights42,f_bias12): 
    print "loading data...",        
    ...
    cPickle.dump([f_p_y_given_xs1,f_weights11,f_weights21,f_weights31,f_weights41,f_bias11,f_p_y_given_xs2,f_weights12,f_weights22,f_weights32,f_weights42,f_bias12], open("new_dump-test.p", "wb"))

...
def build_me(f_weights11,f_weights21,f_weights31,f_weights41,f_bias11,f_weights12,f_weights22,f_weights32,f_weights42,f_bias12):
    # print "loading data...",
    ...
    print "Pickling..."
    cPickle.dump([f_weights11,f_weights21,f_weights31,f_weights41,f_bias11,f_weights12,f_weights22,f_weights32,f_weights42,f_bias12], open("params_dump190620160101.p", "wb"))

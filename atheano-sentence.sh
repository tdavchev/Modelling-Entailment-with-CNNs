...
THEANO_FLAGS=mode=FAST_RUN,device=gpu0,floatX=float32 python /home/s1045064/dissertation/repo-diss/sentence-classification/conv_net_sentence_singleCNN.py -static -word2vec
